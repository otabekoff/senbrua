...
export class Window extends Adw.ApplicationWindow {
    constructor(params) {
        ...
        Settings.bind("noise-reduction-enabled", this._noiseSwitch, "active", Gio.SettingsBindFlags.DEFAULT);
    ...
    setupThemeRadios() {
        ...
        this.colorSchemeHandler = Settings.connect("changed::color-scheme", () => {
    ...
    setupFormatRadios() {
        ...
        // Listen for external changes
        this.formatSettingsHandler = Settings.connect("changed::audio-profile", () => {
    ...
    setupChannelRadios() {
        ...
        // Listen for external changes
        this.channelSettingsHandler = Settings.connect("changed::audio-channel", () => {
    ...
    sendNotification(message, recording, index) {
        ...
        toast.connect("dismissed", () => {
            ...
            this.toastUndo = false;
            this.undoToasts = this.undoToasts.filter((undoToast) => undoToast.title !== toast.title);
        });
